...
#import "ZGTNASValuePopUpView.h"

@protocol ASValueTrackingSliderDelegate;

@interface ZGTNASValueTrackingSlider : UISlider
...
@property (strong, nonatomic, readonly) ZGTNASValuePopUpView *popUpView;
...
- (void)sliderWillDisplayPopUpView:(ZGTNASValueTrackingSlider *)slider;

@optional
- (void)sliderWillHidePopUpView:(ZGTNASValueTrackingSlider *)slider;
- (void)sliderDidHidePopUpView:(ZGTNASValueTrackingSlider *)slider;
@end
